...
const ImageTextBox = ({
  ...
  const imgInView = useInView(imgRef, { once: true, amount: 0.6 });
  ...
  return (
    <>
      ...
      <section
        className={`overflow-x-hidden text-black flex flex-col justify-center items-center pt-8 pb-8 relative mx-auto max-w-[1200px] ${
